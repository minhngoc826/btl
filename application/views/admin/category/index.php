...
<div class="wrapper">
	...
	<div class="widget">
		...
		<div class="title">
			...
			<h6>Danh sách danh mục file</h6>
			<div class="num f12">
				Tổng số: <b><?php echo count($list)?></b>
			</div>
		</div>
		...
		<table cellpadding="0" cellspacing="0" width="100%"
					...
					<td colspan="7">
						<div class="list_action itemActions">
							<a href="#submit" id="submit" class="button blueB"
								url="<?php echo admin_url('category/delete_all')?>"> <span
			...
			<tr class="row_<?php echo $row->id?>">
					...
					<td><span title="<?php echo $row->catname?>" class="tipS">
							<?php echo $row->catname?>				
						</span></td>


					<td class="option"><a
						href="<?php echo admin_url('category/edit/'.$row->id)?>"
						title="Chỉnh sửa" class="tipS "> <img
							src="<?php echo public_url('admin')?>/images/icons/color/edit.png" />
					</a> <a href="<?php echo admin_url('category/delete/'.$row->id)?>"
