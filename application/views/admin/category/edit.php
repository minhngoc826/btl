      ...
      <form id="form" class="form" enctype="multipart/form-data" method="post" action="<?php echo admin_url('category/edit'.$info->id) ?>">
          <fieldset>
                ...
                <div class="formRow">
                	...
                	<div class="formRight">
                		<span class="oneTwo"><input type="text" _autocheck="true" id="param_name" value="<?php echo $info->catname?>" name="name"></span>
                		...
                		<span class="oneTwo">
                    		<select _autocheck="true" id="param_parent_id"  name="parent_id">
                    		     ...
                    		     <?php foreach ($list as $row):?>
                    		       <option value="<?php echo $row->id?>" <?php echo ($row->id == $info->parent_id) ? 'selected' : '';?>><?php echo $row->catname?></option>
                    		     <?php endforeach;?>
                    		</select>
                		</span>
