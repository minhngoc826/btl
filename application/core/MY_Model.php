...
// 	    $this->db->select('*');
	 ...
	 * Lay tong so
	 */
	function get_total($input = array(), $bool='')
	{
		$this->get_list_set_input($input, $bool);
	 ...
	 * Lay 1 row
	 */
	function get_row($input = array(), $bool=''){
		$this->get_list_set_input($input, $bool);
	 ...
	 */
	function get_list($input = array(), $bool='')
	{
	...
	protected function get_list_set_input($input = array(), $bool='')
	{
		...
		else
		{
			...
			if ($bool) $order = ($this->order == '') ? array($this->table.'.'.$this->key, 'desc') : $this->order;
			else $order = ($this->order == '') ? array($this->table.'.'.$this->key, 'asc') : $this->order;
