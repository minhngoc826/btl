	...
	<div class="widgets">
		...
		<div class="oneTwo">
			<div class="widget">
				<div class="title">
					<img class="titleIcon"
						src="<?php echo public_url('admin')?>/images/icons/dark/money.png">
					<h6>Doanh số</h6>
				</div>
				...
				<table width="100%" cellspacing="0" cellpadding="0"
					...
					<tbody>
						...
						<tr>
							...
							<td style="width: 120px;" class="textR webStatsLink red">44,000,000
								đ</td>
						</tr>
		...
		<div class="oneTwo">
			<div class="widget">
				<div class="title">
					<img class="titleIcon"
						src="<?php echo public_url('admin')?>/images/icons/dark/users.png">
		...
		<div class="widget">
			<div class="title">
				<span class="titleIcon"><div class="checker" id="uniform-titleCheck">
			...
			<table width="100%" cellspacing="0" cellpadding="0" id="checkAll"
					...
					<tr>
						<td colspan="8">
							<div class="list_action itemActions">
								<a url="admin/tran/del_all.html" class="button blueB"
				...
				<tbody class="list_item">
					...
					<tr>
						...
						<td class="textC"><a class="lightbox cboxElement"
							href="admin/tran/view/16.html"> <img
								src="<?php echo public_url('admin')?>/images/icons/color/view.png">
						</a> <a class="tipS verify_action" href="admin/tran/del/16.html"
							original-title="Xóa"> <img
								src="<?php echo public_url('admin')?>/images/icons/color/delete.png">
						</a></td>
					</tr>
					<tr>
						<td><div class="checker" id="uniform-undefined">
								<span><input type="checkbox" value="15" name="id[]"
									style="opacity: 0;"></span>
							</div></td>
						...
						<td class="textC"><a class="lightbox cboxElement"
							href="admin/tran/view/15.html"> <img
								src="<?php echo public_url('admin')?>/images/icons/color/view.png">
						</a> <a class="tipS verify_action" href="admin/tran/del/15.html"
							original-title="Xóa"> <img
								src="<?php echo public_url('admin')?>/images/icons/color/delete.png">
						</a></td>
					</tr>
					<tr>
						<td><div class="checker" id="uniform-undefined">
								<span><input type="checkbox" value="14" name="id[]"
									style="opacity: 0;"></span>
							</div></td>
						...
						<td class="textC"><a class="lightbox cboxElement"
							href="admin/tran/view/14.html"> <img
								src="<?php echo public_url('admin')?>/images/icons/color/view.png">
						</a> <a class="tipS verify_action" href="admin/tran/del/14.html"
							original-title="Xóa"> <img
								src="<?php echo public_url('admin')?>/images/icons/color/delete.png">
						</a></td>
					</tr>
					<tr>
						<td><div class="checker" id="uniform-undefined">
								<span><input type="checkbox" value="13" name="id[]"
									style="opacity: 0;"></span>
							</div></td>
						...
						<td class="textC"><a class="lightbox cboxElement"
							href="admin/tran/view/13.html"> <img
								src="<?php echo public_url('admin')?>/images/icons/color/view.png">
						</a> <a class="tipS verify_action" href="admin/tran/del/13.html"
							original-title="Xóa"> <img
								src="<?php echo public_url('admin')?>/images/icons/color/delete.png">
						</a></td>
					</tr>
					<tr>
						<td><div class="checker" id="uniform-undefined">
								<span><input type="checkbox" value="12" name="id[]"
									style="opacity: 0;"></span>
							</div></td>
						...
						<td class="textC"><a class="lightbox cboxElement"
							href="admin/tran/view/12.html"> <img
								src="<?php echo public_url('admin')?>/images/icons/color/view.png">
						</a> <a class="tipS verify_action" href="admin/tran/del/12.html"
							original-title="Xóa"> <img
								src="<?php echo public_url('admin')?>/images/icons/color/delete.png">
						</a></td>
					</tr>
