...
<div class="wrapper">
	...
	<form enctype="multipart/form-data" method="post"
		action="<?php echo admin_url('file/add')?>" id="form" class="form">
		<fieldset>
			<div class="widget">
				<div class="title">
					<img class="titleIcon"
				...
				<div class="tab_container">
					<div class="tab_content pd0" id="tab1" style="display: block;">
						...
						<div class="formRow">
							<label for="param_cat" class="formLeft">Thể loại:<span
								class="req">*</span></label>
							<div class="formRight">
								<select name="categoty" class="left">
									<option value=""></option>
									<!-- kiem tra danh muc co danh muc con hay khong -->
				<?php foreach ($categotys as $row):?>
				<?php if(count($row->subs) > 1):?>
  				<optgroup label="<?php echo $row->name?>">
           		...
           		<?php endif;?>
           		<?php endforeach;?>
		</select> <span class="autocheck" name="cat_autocheck"></span>
						...
						<!-- warranty -->
						<div class="formRow">
							<label for="param_warranty" class="formLeft"> Bảo hành : </label>
							<div class="formRight">
								<span class="oneFour"><input type="text" id="param_warranty"
									name="warranty"></span> <span class="autocheck"
